...
Template = function ($, common, api, Document) {
  ...
  Template.prototype.isDirty = function () {
    var isDirty = Document.prototype.isDirty.call(this);
    if (!isDirty && this.raw) {
      isDirty = this.name != this.raw.name || this.subject != this.raw.subject || this.body != this.raw.body || this.format != this.raw.format || this.dialect != this.raw.dialect || this.kind != this.raw.kind || this.askSignature != this.raw.askSignature || this.width != this.raw.width || this.height != this.raw.height || this.unit != this.raw.unit;
    }
    return isDirty;
  };
  //
