...
var p={};return p.api=a,p.Attachment=b,p.Base=c,p.Comment=d,p.Contact=f,p.DateHelper=g,p.Document=h,p.Helper=m,p.Item=i,p.KeyValue=j,p.Location=k,p.Order=l,p.Reservation=n,p.Transaction=o,p}),g("jquery",function(){return a}),g("jquery-jsonp",function(){return b}),g("jquery-pubsub",function(){return c}),g("moment",function(){return d}),f("../main")});